let projects = [
	{
		id: 1,
		name: "DEVSOC Hackathon Portal",
		description:
			"DEVSOC'21 was India's largest student run hackathon. I worked on its online portal, which was used for everything from the registration, updates to the final submission.",
		src: "devsoc.png",
		tech: "ReactJS, Material UI, ExpressJS, MongoDB, AWS, etc.",
		link: "https://hackwith.codechefvit.com/",
		git: "https://github.com/CodeChefVIT/DEVSOC-Main-Portal",
	},
	{
		id: 2,
